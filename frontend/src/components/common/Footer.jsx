        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-lg font-bold text-white tracking-wide">REMO NORTH LOCAL GOVERNMENT</span>
                <p className="text-xs text-civic-400 font-medium">Ogun State, Nigeria | E-Government Portal</p>
              </div>
            </div>
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              Empowering citizens across Isara-Remo, Ode-Remo, Ipara, Akaka, Ilara, and neighboring wards with seamless digital access to municipal services, transparent request tracking, and responsive community problem resolution.
            </p>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-sm text-slate-400">
              <li className="flex items-start gap-2.5">
                ...
                <span>Local Government Secretariat Complex, Palace Way, Isara-Remo, Ogun State</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="w-4 h-4 text-civic-400 shrink-0" />
                <span>+234 (0) 803 111 2233</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-civic-400 shrink-0" />
                <span>helpdesk@remonorth.og.gov.ng</span>
              </li>
            </ul>
          </div>
        </div>
